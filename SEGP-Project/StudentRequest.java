...
public class StudentRequest implements ActionListener{
	...
	private void initialize() {
		...
		lblReason.setBounds(68, 170, 46, 14);
		panel.add(lblReason);
		
		textArea = new JTextArea();
		textArea.setBounds(153, 165, 246, 70);
		panel.add(textArea);
		
		btnSubmit = new JButton("Submit");
		btnSubmit.setBounds(335, 239, 89, 23);
		btnSubmit.addActionListener(this);
		panel.add(btnSubmit);
		
		lblPreviousPat = new JLabel("New Pat");
		lblPreviousPat.setBounds(67, 140, 92, 14);
		panel.add(lblPreviousPat);
		
		textField_4 = new JTextField();
		textField_4.setBounds(152, 137, 126, 20);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnBack){
			...
			d.studentRequest(textField.getText(),textField_1.getText(),textField_2.getText(), textField_3.getText(),textField_4.getText(),textArea.getText());
